...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/username/nameservice/nameservice/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<NameserviceQueryParamsResponse, RpcStatus>({
      path: `/username/nameservice/nameservice/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/username/nameservice/nameservice/whois
   */
  queryWhoisAll = (
    query?: {
    ...
    this.request<NameserviceQueryAllWhoisResponse, RpcStatus>({
      path: `/username/nameservice/nameservice/whois`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/username/nameservice/nameservice/whois/{index}
   */
  queryWhois = (index: string, params: RequestParams = {}) =>
    this.request<NameserviceQueryGetWhoisResponse, RpcStatus>({
      path: `/username/nameservice/nameservice/whois/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
